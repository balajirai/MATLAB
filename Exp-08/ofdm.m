...
M = 8;       % Modulation order for QAM -> tradeoff between error rate and data rate
...
nSym  = 4;   % Number of symbols per RE -> higher nSym, more symbols transmitted in same duration, higher symbol density -> ISI vs data rate
